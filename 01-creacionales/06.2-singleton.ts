...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!this.instance) {
      ...
      console.log('\n%cConectando a la base de datos', COLORS.blue)
    }
  ...
  public connect(): void {
    ...
    if (this.connected) {
      console.log('%cYa estábamos conectados en la base de datos', COLORS.red)
      return
    }
    this.connected = true
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      console.log('Desconectamos la conexión a la base de datos')
      this.connected = false
      return
    }
