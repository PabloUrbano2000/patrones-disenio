...
class SoundSystem {
  on() {
    console.log('Sistem de sonido encendido')
  }

  off() {
    console.log('Sistem de sonido apagado')
  }
}
...
function main() {
  ...
  const homeTheather = new HomeTheaterFacade({
    projector,
    soundSystem,
    videoPlayer,
    popcornMaker
  ...
  homeTheather.watchMovie('Los Avengers')
